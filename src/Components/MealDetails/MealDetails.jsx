                  ...
                  <div className="card-body">
                    ...
                    <div className="row flex-wrap justify-content-center shadow rounded-3 m-2 mt-4">
                      ...
                      {ingredients.map((ingredient, index) => (
                        <div key={`${ingredient.ingredient}-${ingredient.measure}`} className="ingredient col-1 col-sm-1 col-lg-2 col-xl-2 my-2 text-center ingredient-container">
                          <div className="bg-cardbody rounded-4 p-2">
                            <img src={`https://www.themealdb.com/images/ingredients/${ingredient.ingredient.split(' ').pop()}-small.png`} alt="" className="card-img-top img-fluid" />
                          </div>
